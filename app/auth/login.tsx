import { useRouter } from 'expo-router'; // Changed from native navigation
...
export default function LoginScreen() {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      // Use router.push to navigate safely with search query params
      setTimeout(() => {
        router.push({
          pathname: '/auth/otp',
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '800', color: '#ffffff', textAlign: 'center', marginBottom: 6 },
  subtitle: { fontSize: 14, color: '#cbd5e1', textAlign: 'center', lineHeight: 20, marginBottom: 28 },
  ...
  input: { backgroundColor: '#0f172a', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, color: '#ffffff', borderWidth: 2, borderColor: '#475569' },
  loginButton: { backgroundColor: '#10b981', borderRadius: 12, paddingVertical: 16, alignItems: 'center', justifyContent: 'center', marginTop: 8 },
